                            ...
                            <div class="card">
                                <DataTable :value="equipments" removableSort sortMode="multiple" tableStyle="min-width: 50rem">
                                    ...
                                    <Column field="model" header="Модель">
                                        <template #body="slotProps">
                                            <a class="text-blue-600" :href="route('crm.models.show', [slotProps.data.generation.model.id])" v-text="slotProps.data.generation.model.name" />
                                        </template>
                                    </Column>
                                    <Column field="brand" header="Марка">
                                        <template #body="slotProps">
                                            <a class="text-blue-600" :href="route('crm.brands.show', [slotProps.data.generation.model.brand.id])" v-text="slotProps.data.generation.model.brand.name" />
                                        </template>
                                    </Column>
                                </DataTable>
                            </div>
